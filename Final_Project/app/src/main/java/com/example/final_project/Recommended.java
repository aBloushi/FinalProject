...
public class Recommended extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RecyclerView rv = findViewById(R.id.erree);
        ...
        Books TheHungerGames2 = new Books("The Hunger Games: Catching Fire", R.drawable.hunger2, "September 1, 2009", getResources().getString(R.string.Hunger2), "h3.pdf", "https://www.youtube.com/watch?v=WUALEh54jBA&t");
        ...
        NewAdapter ad = new NewAdapter(Bookshelf, this);
        rv.setAdapter(ad);
